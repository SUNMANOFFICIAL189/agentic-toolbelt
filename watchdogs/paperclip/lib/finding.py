"""
Shared Finding type for Paperclip watchdog runtime rules.
...
Convention:
    rule_id            stable identifier (e.g., 'paperclip-runtime-burn-rate')
...
Mirrors ~/claude-hq/watchdogs/pats/lib/finding.py. Kept separate per-watchdog
so each Tier 1 instance is self-contained; if drift becomes painful, refactor
both watchdogs onto a ~/claude-hq/watchdogs/_shared/ package later.
"""
